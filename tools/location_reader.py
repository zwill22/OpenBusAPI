...
def check_response(**kwargs):
    ...
    """
    result = analyse_response(**kwargs)
    check_result(result)
...
def check_file(file: str = None, **kwargs):
    """
    ...
    check_response(response_string=response_string, **kwargs)
...
if __name__ == "__main__":
    ...
    check_file(**vars(parser.parse_args()))
